...
/**
 * Fetches a list of books from the API with pagination, sorting, and search capabilities
 * @async
 * @param {number} [page=1] - The page number to fetch
 * @param {number} [limit=8] - The number of books per page
 * @param {string} [sortBy='relevance'] - The sorting criteria (e.g., 'relevance', 'price_low_to_high')
 * @param {string} [search=''] - The search query for filtering books
 * @returns {Promise<Object>} An object containing the books array and totalRecords
