...
/**
 * AuthCard component for user login and signup functionality
...
const AuthCard = ({ role }) => {
  ...
  /**
   * Handles switching between login and signup views
   * @param {string} view - The view to switch to ('login' or 'signup')
   * @returns {void}
   */
  ...
  /**
   * Validates input fields for login or signup
